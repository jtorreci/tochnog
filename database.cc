...

{
  ...
  strcpy(name[GROUNDFLOW_PHREATICLEVEL_MULTIPLE],"groundflow_phreaticlevel_multiple");
  ...
  strcpy(name[GROUNDFLOW_PHREATICLEVEL_MULTIPLE_ELEMENT],"groundflow_phreaticlevel_multiple_element");
  ...
  strcpy(name[GROUNDFLOW_PHREATICLEVEL_MULTIPLE_ELEMENT_GEOMETRY],"groundflow_phreaticlevel_multiple_element_geometry");
  ...
  strcpy(name[GROUNDFLOW_PHREATICLEVEL_MULTIPLE_ELEMENT_GROUP],"groundflow_phreaticlevel_multiple_element_group");
  ...
  strcpy(name[GROUNDFLOW_PHREATICLEVEL_MULTIPLE_N],"groundflow_phreaticlevel_multiple_n");
  ...
  strcpy(name[GROUNDFLOW_PHREATICLEVEL_MULTIPLE_NODE],"groundflow_phreaticlevel_multiple_node");
  ...
  strcpy(name[GROUNDFLOW_PHREATICLEVEL_MULTIPLE_STATIC],"groundflow_phreaticlevel_multiple_static");
