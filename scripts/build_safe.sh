...
#   - Verificacion automatica: corre la suite de tests (13 tests / 22 runs)
#     y comprueba targets.
#
...
# clamp numerico del MC) -> 10 runs de la familia.
for t in hypo1 hypo2 hypo3 hypo4 smooth1 dof1 mlx1 vtk_dof1 gen1 genbeam1 reset1 cda1 \
         ...
         iface_mc_mem iface_mc_dil iface_mc_dil_1step iface_mc_num; do
...
echo "==> Resumen: $HIPO_OK/$HIPO_TOTAL runs OK (13 tests: 12 preexistentes + familia iface_mc en 10 runs)."
