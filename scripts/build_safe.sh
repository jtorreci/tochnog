...
#   - Verificacion automatica: corre la suite de tests (13 tests / 19 runs)
#     y comprueba targets.
#
...
# + iface_mc_mem (memory -total_linear, 7mo run).
...
echo "==> Resumen: $HIPO_OK/$HIPO_TOTAL runs OK (13 tests: 12 preexistentes + familia iface_mc en 7 runs)."
