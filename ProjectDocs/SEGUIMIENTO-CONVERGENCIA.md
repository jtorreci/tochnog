...
- ~~`interface_bar3_quad8`~~: **CERRADO 2026-09-04 (sprint 2D L1+L2)** — bar3→quad6 en 2D + quad8→quad9: rc=0 (ver la fila del registro 2026-09-04 y la sección del sprint al final). `interface_quad8_hex20`: sigue PARSE por `-hex20` (volumen serendipity 3D no registrado; su cara `-quad8` de interfaz → hex18 es el lote 3D futuro).
...
| quad8 en grupo de interfaz NO convertido | interface_quad8_hex20 sigue PARSE por `-hex20` (lote 3D futuro); la cara quad8 3D es un elemento facial, no un volumen |
...
**Pendientes**:
- `-hex20` (volumen 3D serendipity → hex27) y la cara `-quad8` de interfaz 3D → hex18 (interface_quad8_hex20: PARSE por -hex20).
