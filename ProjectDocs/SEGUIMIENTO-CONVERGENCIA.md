...
- [x] `control_slide_plasti_apply` — lote keywords baratas (registrado; sin consumo)
- [x] `control_slide_stiffness_apply` — lote keywords baratas (registrado; sin consumo)
...
- [x] `slide_plasti_friction` — lote keywords baratas (registrado phi c con la familia slide_plasti_tension/stiffness/residual_stiffness + control_slide_*_apply; consumo PENDIENTE — slide1/4 corren sin constrenir)
- [x] `slide_plasti_tension` — lote keywords baratas (registrado; sin consumo)
- [x] `slide_stiffness` — lote keywords baratas (registrado; sin consumo)
