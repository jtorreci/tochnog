...
- [ ] `group_materi_plasti_mohr_coul_direct` — PENDIENTE
- [ ] `group_materi_plasti_mohr_coul_direct_normal` — PENDIENTE
- [ ] `group_materi_plasti_mohr_coul_direct_normal_automatic` — PENDIENTE
...
- [ ] `group_materi_plasti_tension_direct` — PENDIENTE
- [ ] `group_materi_plasti_tension_direct_normal` — PENDIENTE
- [ ] `group_materi_plasti_tension_direct_normal_automatic` — PENDIENTE
...
- [ ] `materi_displacement_relative` — PENDIENTE
