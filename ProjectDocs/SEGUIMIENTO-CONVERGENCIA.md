...
> NOTA (sub-sprint materi_stress_force, lote 1, 2026-08-28): la fila
> anterior (`control_print_materi_stress_force`) NO se toca aún porque la
> integración numérica no está funcional (el lote 1 es infraestructura:
> registro + dispatch + print con valores 0). Se ELIMINARÁ de esta tabla
> cuando la integración 2D/3D (L2/L3) funcione y la feature quede
> completa.
...
- [x] `post_calcul_materi_stress_force_average` — sub-sprint materi_stress_force, lote 1 (2026-08-28; quad9/hex27: promedio de las fuerzas/momentos de las caras opuestas en los nodos del plano medio; default -yes; el promediado llega en L2/L3)
...
- [x] `post_calcul_materi_stress_force_outer` — sub-sprint materi_stress_force, lote 1 (2026-08-28; -yes restringe a los nodos exteriores, los más lejanos del reference_point; default -no)
- [x] `post_calcul_materi_stress_force_plot_switch` — sub-sprint materi_stress_force, lote 1 (2026-08-28; invierte la dirección de los vectores de plot; 3 switches en 2D / 4 en 3D — por VECTOR item, no por resultado)
- [x] `post_calcul_materi_stress_force_reference_point` — sub-sprint materi_stress_force, lote 1 (2026-08-28; punto de referencia por element group (ndim valores); 3D obligatorio, 2D sin él → aviso + default (0,0) documentado)
