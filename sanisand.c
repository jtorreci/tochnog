  ...
  int plastic)
{
  ...
  if (bisect == 1) {
    /* Fortran bisection: narrows the interval [y00,y11] by the sign of fy.
       y00=y0, y11=y1; y05=(y00+y11)/2; if fy(y05)<0 -> y00=y05 else y11=y05. */
